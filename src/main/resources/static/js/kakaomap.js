...
/* 일지 확인하기 */
/* ************************************************************************ */
var readContent = document.getElementById('read').innerHTML;
var positions = [
    {
        title: '카카오',
        content: readContent,
        latlng: new kakao.maps.LatLng(37.400666, 126.927537)
    },
    {
        title: '생태연못',
        content: readContent,
        latlng: new kakao.maps.LatLng(37.398007, 126.940731)
    },
    {
        title: '텃밭',
        content: readContent,
        latlng: new kakao.maps.LatLng(37.401023, 126.922025)
    },
    {
        title: '근린공원',
        content: readContent,
        latlng: new kakao.maps.LatLng(37.395189, 126.927994)
    },
    {
        title: '근린공원2',
        content: readContent,
        latlng: new kakao.maps.LatLng(37.408189, 126.937994)
    }
];
...
$.get("../test/chicken.json", function(data) {
